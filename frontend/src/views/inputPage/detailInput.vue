		...
		<v-card class="d-flex flex-row">
			<div class="w-50 m-2">
				<div class="d-flex justify-content-center">
					<v-btn class="flex-grow-1 mx-2" @click="
			...
			<div class="w-50 m-2 d-flex flex-column justify-content-between">
				<div>
					<div class="mx-4 my-2">
						<v-select v-model="inputType" label="種類" :items="typeList" variant="underlined" hide-details
					...
					<v-expansion-panels>
						<v-expansion-panel>
							...
							<v-expansion-panel-text>
								<v-select :items="[
									...
									'每季重複',
									'每年重複',
								]" v-model="autoRepeatInterval" label="自動重複間隔" hide-details variant="underlined"></v-select>
								<div class="d-flex align-items-center">
									<v-switch v-model="autoRepeatUntil" :label="autoRepeatUntil
										? '重複直到'
										: '不設定結束日期'
										" hide-details inset>
									</v-switch>
						...
						<v-expansion-panel>
							...
							<v-expansion-panel-text>
								...
								<div v-else-if="
									cosumeBy.userType === '比例分配' ||
									cosumeBy.userType === '金額分配'
								">
									<!-- v-for當前群組 -->
